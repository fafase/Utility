...
namespace Tools
{
    public abstract class FSM : MonoBehaviour
    {
        ...
        protected bool CreateNewState(Enum newstate)
        {
            ...
            s.enterMethod = FSM.GetMethodInfoInheritance<Action<Enum>>(this, type, "Enter" + newstate, DoNothingEnterExit);
            s.updateMethod = FSM.GetMethodInfoInheritance<Action>(this, type, "Update" + newstate, DoNothingUpdate);
            s.fixedUpdateMethod = FSM.GetMethodInfoInheritance<Action>(this, type, "FixedUpdate" + newstate, DoNothingUpdate);
            s.lateUpdate = FSM.GetMethodInfoInheritance<Action>(this, type, "LateUpdate" + newstate, DoNothingUpdate);
            s.exitMethod = FSM.GetMethodInfoInheritance<Action<Enum>>(this, type, "Exit" + newstate, DoNothingEnterExit);
